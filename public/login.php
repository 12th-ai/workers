...
<body>
   ...
   <div class="h-[calc(100vh-100px)] border flex justify-center items-center">
      <div class="border p-[30px] min-w-[500px]">
         <h1 class="text-[18px] uppercase font-semibold text-center mb-[25px] text-defClr">Login To "Lorem"</h1>
         <form class="grid gap-y-4" method="POST">
            <div class="flex flex-col gap-y-[8px]">
               <label class="text-[15px]">Phone Number</label>
               <input type="text" name="phone" placeholder="07xxxxxxxx" id="" class="px-[15px] bg-transparent border py-[6px] text-[14px] outline-none">
            </div>
            <div class="flex flex-col gap-y-[8px]">
