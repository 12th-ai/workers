...
<body>
   ...
   <main>
      ...
      <div class="flex">
         <div class="w-[300px] h-[300px] border mr-[30px]">
            <img src="../assets/profiles/<?php echo $img?>" class="w-full h-full object-cover" alt="">
         </div>
         <div>
            ...
            <p class="text-[17px] my-[10px]">Education Level: <?php echo $ed?></p>
            <div class="flex gap-x-3">
               <a href="" class="py-[3px] px-[15px] bg-defClr text-white">Call</a>
               <a href="" class="py-[3px] px-[15px] bg-defClr text-white">Hire</a>
            </div>
         </div>
      </div>
