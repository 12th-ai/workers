   ...
   <main>
      ...
      <div>
         <div class="flex gap-x-4">
            <button class="text-[15px] border px-4 py-2 rounded-sm bg-themeClr border-themeClr activeBtn tabButton" data-tab="all">My Jobs (1
               )</button>
         ...
         <div class="grid grid-cols-[repeat(3,100%)] gap-x-10 overflow-x-hidden">
            <div id="all" class="eachTab">
               <div class="mt-[30px]">
                  <h1 class="text-[17px]">My Jobs (1)</h1>
                  <hr class="my-3">
               </div>
            ...
            <div id="my" class="eachTab">
               ...
               <div class="grid gap-y-[20px]">
                  <div class="border py-3 text-[15px] px-5 rounded-md">
                     <a href="" class="font-medium mb-[10px] flex text-[18px]">Job 1, Lorem ipsum dolor sit amet consectetur adipisicing elit. Non?</a>
                     <p>Location: Nyarugenge</p>
                     <p>Salary: 20000 FRW</p>
                     <div class="mt-[20px] flex gap-x-[20px] items-center">
                        <a href="" class="py-2 px-5 text-[14px] bg-defClr rounded-md text-red-900 font-semibold bg-red-400 ">Discard</a>
                        <a href="" class="">More Details</a>
                     </div>
                  </div>
                  <div class="border py-3 text-[15px] px-5 rounded-md">
                     ...
                     <div class="mt-[20px] flex gap-x-[20px] items-center">
                        <a href="" class="py-2 px-5 text-[14px] bg-defClr rounded-md text-white">Apply</a>
                        <a href="" class="font-medium">More Details</a>
                     </div>
                  </div>
                  <div class="border py-3 text-[15px] px-5 rounded-md">
                     <a href="" class="font-medium mb-[10px] flex text-[18px]">Job 1, Lorem ipsum dolor sit amet consectetur adipisicing elit. Non?</a>
